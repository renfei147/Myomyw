class OptionScene extends MenuScene {
    constructor() {
        super(txt.options.title, function () {
        ...
        const standaloneTimerBox = creator.createCheckBoxButton(txt.options.standaloneTimer, cc.size(600, 60),
        ...
        if (!cc.sys.isNative) {
            const forceCanvasBox = creator.createCheckBoxButton(txt.options.forceCanvas, cc.size(600, 120),
